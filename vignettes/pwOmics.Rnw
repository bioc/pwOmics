...
\begin{subfigure}{.5\textwidth}
    \centering
    \includegraphics [trim=0.7cm 2.5cm 0.7cm 0cm, width = 1\linewidth]{ConsensusGraphs_1.pdf}
    \caption{Time point 1 hr.}
\end{subfigure}%    
\begin{subfigure}{.5\textwidth}
    \centering
    \includegraphics [trim=0.7cm 2.5cm 0.7cm 0cm, width = 1\linewidth]{ConsensusGraphs_2.pdf}
    \caption{Time point 4 hrs.}
\end{subfigure}   
