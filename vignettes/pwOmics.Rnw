...
gathered over time - as it is the case in the consensus-based dynamic analysis
...
\centering
\begin{tabular}{@{}c@{}}
    \includegraphics [trim=0.7cm 2.5cm 0.7cm 0cm, width = 0.45\linewidth]{ConsensusGraphs_1.pdf}\\[\abovecaptionskip]
    \small Time point 1 hr.
\end{tabular} 
\vspace{1cm}
\begin{tabular}{@{}c@{}}
    \includegraphics [trim=0.7cm 2.5cm 0.7cm 0cm, width = 0.45\linewidth]{ConsensusGraphs_2.pdf}\\[\abovecaptionskip]
    \small Time point 4 hrs.
\end{tabular}   
\caption{\textit{pwOmics} static consensus graphs.}
\label{fig:Consgraph}
\end{figure}
